/** 
 * ProfileDetailsStep Component
 * 
 * Core component handling role-specific profile details collection with:
 * - Dynamic form fields based on user role (mentor/mentee)
 * - Validation for required fields
 * - Role-specific data submission
 * 
 * Form Fields:
 * - Mentor: Years of experience, expertise, availability
 * - Mentee: Education level, field of interest, learning goals
 * 
 * Props:
 * @prop {object} role - Currently selected role with metadata
